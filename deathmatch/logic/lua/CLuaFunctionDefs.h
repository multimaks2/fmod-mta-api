...
public:
    ...
    LUA_DECLARE(setDiscordActivity);

    //    // FMOD ARRAY
    //LUA_DECLARE(initArray)
    //LUA_DECLARE(deleteArray)
    //LUA_DECLARE(isMyArray)

    //    // FMOD CORE
    //LUA_DECLARE(createCoreFmod)
    //LUA_DECLARE(initFmodCore)
    //LUA_DECLARE(closeCoreFmod)
    //LUA_DECLARE(IsFmodInit)

    //    // FMOD STUDIO
    //LUA_DECLARE(createFmodStudioCore)
    //LUA_DECLARE(initFmodStudio)
    //LUA_DECLARE(closeStudioFmod)
    //LUA_DECLARE(IsFmodStudioInit)

    //    // FMOD GLOBAL CLOSE
    //LUA_DECLARE(globalCloseFmod)
