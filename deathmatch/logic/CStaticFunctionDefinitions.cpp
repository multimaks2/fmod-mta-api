...
//}
//
//const char* FMODErrorCheck(FMOD_RESULT result, const char* funcName)
//{
...
//{
//    int mnNextChannelId;
//    using testBank = std::map<SString, std::map<SString, SString>>;
//    using BankMap = std::map<SString, FMOD::Studio::Bank*>;
//    using SoundMap = std::map<SString, FMOD::Sound*>;
//    using ChannelMap = std::map<int, FMOD::Channel*>;
//    using EventMap = std::map<SString, FMOD::Studio::EventInstance*>;
//
//
//    BankMap            mBanks;
//    EventMap           mEvents;
...
//
//
//void CStaticFunctionDefinitions::initArray()
//{
//    ArrayMap = new myArray();
//}
//
//void CStaticFunctionDefinitions::deleteArray()
//{
//    delete ArrayMap;
//    ArrayMap = nullptr;
//}
//
//bool CStaticFunctionDefinitions::isMyArray()
//{
//    return (ArrayMap != nullptr);
//}
//
// bool is_fmod_core_init = false;
//bool CStaticFunctionDefinitions::IsFmodInit()
//{
//    return is_fmod_core_init;
//}
//
// bool is_fmod_studio_init = false;
//bool CStaticFunctionDefinitions::IsFmodStudioInit()
//{
//    return is_fmod_studio_init;
//}
//
//const char* CStaticFunctionDefinitions::createFmodStudioCore()
//{
//    if (CStaticFunctionDefinitions::IsFmodStudioInit() == false)
//    {
//        is_fmod_studio_init = true;
//        return FMODErrorCheck(FMOD::Studio::System::create(&f_studio), "create Studio Core");
//        f_studio->update();
//    }
//    else
//        return "fmod studio has already been created";
//}
//
//const char* CStaticFunctionDefinitions::createCoreFmod()
//{
//    if (CStaticFunctionDefinitions::IsFmodInit() == false)
//    {
//        is_fmod_core_init = true;
//        return FMODErrorCheck(FMOD::System_Create(&f_system), "create Core");
//        f_system->update();
//    }
//    else
//        return "fmod core has already been created";
//}
//
//FMOD::System* CStaticFunctionDefinitions::GetFmodSystem()
//{
//    if (CStaticFunctionDefinitions::IsFmodInit())
//    {
//        return f_system;
//    }
//    return nullptr;
...
//
//
//const char* CStaticFunctionDefinitions::closeCoreFmod()
//{
//    if (CStaticFunctionDefinitions::IsFmodInit())
//    {
//        f_system->update();
...
//}
//
//const char* CStaticFunctionDefinitions::closeStudioFmod()
//{
//    if (f_studio == nullptr)
//    {
...
//    }
//
//    if (CStaticFunctionDefinitions::IsFmodStudioInit() == true)
//    {
//        f_studio->update();
//
...
//
//
//bool CStaticFunctionDefinitions::globalCloseFmod()
//{
//    auto statusOk = "status - OK";
//    if (CStaticFunctionDefinitions::closeCoreFmod() == statusOk && CStaticFunctionDefinitions::closeStudioFmod() == statusOk)
//    {
//        return true;
//    }
//    return false;
...
//}
//
//const char* CStaticFunctionDefinitions::initFmodCore(int mxchannel, const char* flagName)
//{
//    if (CStaticFunctionDefinitions::IsFmodInit() == true)
//    {
...
//}
//
//const char* CStaticFunctionDefinitions::initFmodStudio(int channel, const char* flagName, const char* flag)
//{
//    if (CStaticFunctionDefinitions::IsFmodStudioInit() == true)
//    {
...
//
//
//void CStaticFunctionDefinitions::fmodAllUpdate()
//{
//    if (CStaticFunctionDefinitions::IsFmodInit() == true)
//    {
//    f_system->update();
...
bool CStaticFunctionDefinitions::setDiscordActivity(const char* LargeTxt, const char* sDetails, const char* sState, const char* smallImg, const char* smalltxt,
                                                    bool sTime)
{
    SDiscordActivity activity;

    if (strlen(LargeTxt) < 2 || strlen(sDetails) < 2 || strlen(sState) < 2 || strlen(smalltxt) < 2 || strlen(smalltxt) < 2)
    {
        // m_pCore
        m_pCore->GetDiscordManager()->UpdateActivity(activity, [](EDiscordRes) {});
        g_pCore->SetConnected(true);
        m_pCore->GetDiscordManager()->RegisterPlay(false);
        g_pClientGame->UpdateDiscordState();
        return false;
    };

    activity.large_txt = LargeTxt;
    activity.m_details = sDetails;
    activity.m_state = sState;
    activity.small_image = smallImg;
    activity.small_txt = smalltxt;
    ...
    m_pCore->GetDiscordManager()->UpdateActivity(activity,
                                                 [](EDiscordRes res)
                                                 {
