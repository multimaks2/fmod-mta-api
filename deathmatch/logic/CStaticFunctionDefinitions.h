...
public:
    ...
    //static bool          isMyArray();
    //static const char*   createCoreFmod();
    //static const char*   createFmodStudioCore();
    //static bool          IsFmodInit();
    //static bool          IsFmodStudioInit();
    //static FMOD::System* GetFmodSystem();


    //static const char*   closeCoreFmod();
    //static const char*   closeStudioFmod();
    //static bool          globalCloseFmod();

    //// FMOD API INIT
    //static const char* initFmodCore(int mxchannel, const char* flagName);
    //static const char* initFmodStudio(int channel, const char* flagName, const char* flag);

    //static void fmodAllUpdate();
    //// FMOD API LUA
    ...
    // Discord funcs
    static bool setDiscordActivity(const char* LargeTxt, const char* sDetails, const char* sState, const char* smallImg, const char* smalltxt, bool sTime);
